...
public class FoodDAO {
    ...
    private static final String URL  = "jdbc:mysql://localhost:3306/servlet3";
    ...
    public void addFood(String name, int quantity) {
        String sql = "INSERT INTO foods(name, quantity) VALUES(?, ?)";
    ...
    public List<Food> listFood() {
        String sql = "SELECT id, name, quantity FROM foods ORDER BY id DESC";
    ...
    public void updateFood(int id, String name, int quantity) {
        String sql = "UPDATE foods SET name = ?, quantity = ? WHERE id = ?";
